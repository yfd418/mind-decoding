    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center">
          ...
          <div 
            className={`relative w-full max-w-md mx-4 rounded-2xl shadow-2xl overflow-hidden border backdrop-blur-xl ${
              isDarkMode 
                ? 'bg-forest/65 border-sage-dark/30' 
                : 'bg-white/65 border-sage/20'
            }`}
          >
                  ...
                  className={`block p-4 rounded-xl transition-all duration-300 hover:-translate-y-0.5 ${
                    resource.primary
                      ...
                      : isDarkMode
                        ...
                        : 'bg-white/60 border border-sage/30 hover:bg-white/80'
                  }`}
                >
